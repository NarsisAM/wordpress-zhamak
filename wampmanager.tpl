...
Type: separator; Caption: "Wampserver"
Type: item; Caption: "${w_startedOn} ${WampStartOn}"; Action: Multi; Actions: none; Glyph:43
...
;Action: run; FileName: "${c_phpExe}";Parameters: "refreshSymlink.php ${c_phpVersion}"; WorkingDir: "${c_installDir}/scripts"; ShowCmd: hidden; Flags: waituntilterminated
${Apache_Restart}
Action: run; FileName: "${c_phpCli}";Parameters: "refresh.php"; WorkingDir: "${c_installDir}/scripts"; ShowCmd: hidden; Flags: waituntilterminated
Action: readconfig
;WAMPRELOADEND
...
;WAMPPHPMYADMIN
${SupportDBMS}${adminerMenu}Type: item; Caption: "Adminer		${adminerVersion}"; Action: run; FileName: "${c_navigator}"; Parameters: "${c_edge}http://localhost${UrlPort}/adminer/"; Glyph: 40
;WAMPVHOSTSUBMENU
;WAMPALIASSUBMENU
...
Type: submenu; Caption: "${w_phpExtensions}"; SubMenu: php_ext; Glyph: 4
...
Type: item; Caption: "Changelog"; Glyph: 33; Action: run; FileName: "${c_editor}"; parameters: "${c_phBinDir}/news.txt"
